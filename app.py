"""
Resume Analyzer(AI) - Main Application
"""
import time
...
class ResumeApp:
    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <p style='text-align: center;'>
                ...
                <a href="https://www.linkedin.com/in/latamishra5/" target="_blank" style='text-decoration: none; color: #FFFFFF'>
                    <b>Lata Mishra</b>
                </a>
            </p>
            """, unsafe_allow_html=True)
    ...
    def render_dashboard(self):
        ...
        st.toast("Check out these repositories: [Awesome Hacking](https://github.com/latamishra5/Awesome-Hacking)", icon="ℹ️")
    ...
    f"Email input value: {st.session_state.get('email_input', '')}")
        ...
        st.toast("Check out these repositories: [30-Days-Of-Rust](https://github.com/latamishra5/30-Days-Of-Rust)", icon="ℹ️")
     ...
     "124852522.jpeg")
        ...
        st.markdown("""
            <div class="hero-section">
                <h1 class="hero-title">About Resume Analyzer(AI)</h1>
        ...
        st.markdown(f"""
            <div class="profile-section">
                <img src="{image_base64 if image_base64 else 'https://avatars.githubusercontent.com/latamishra5'}"
                     alt="Lata Mishra"
                     class="profile-image"
                     onerror="this.onerror=null; this.src='https://avatars.githubusercontent.com/latamishra5';">
                <h2 class="profile-name">Lata Mishra</h2>
                <p class="profile-title">Full Stack Web Developer</p>
                <div class="social-links">
                    <a href="https://github.com/latamishra5" class="social-link" target="_blank">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/latamishra5/" class="social-link" target="_blank">
                        <i class="fab fa-linkedin"></i>
                    </a>
                    <a href="mailto:latamishra987@gmail.com" class="social-link" target="_blank">
                        <i class="fas fa-envelope"></i>
                    </a>
                </div>
                <p class="bio-text">
                    Hello! I'm a passionate Full Stack Web Developer.
                    I created Resume Analyzer(AI) to revolutionize how job seekers approach their career journey.
        ...
        st.markdown("""
            <div class="vision-section">
                ...
                <p class="vision-text">
                    "Resume Analyzer(AI) represents my vision of democratizing career advancement through technology.
        ...
        st.toast("Check out these repositories: [Iriswise](https://github.com/latamishra5/Iriswise)", icon="ℹ️")
    ...
    "Upload your resume", type=[
        ...
        st.toast("Check out these repositories: [Awesome Java](https://github.com/latamishra5/Awesome-Java)", icon="ℹ️")
    ...
    def render_home(self):
        ...
        st.toast("Check out these repositories: [AI-Nexus(AI/ML)](https://github.com/latamishra5/AI-Nexus)", icon="ℹ️")
    ...
    def render_job_search(self):
        ...
        st.toast("Check out these repositories: [GeeksforGeeks-POTD](https://github.com/latamishra5/GeeksforGeeks-POTD)", icon="ℹ️")
    ...
    def render_feedback_page(self):
        ...
        st.toast("Check out these repositories: [TryHackMe Free Rooms](https://github.com/latamishra5/tryhackme-free-rooms)", icon="ℹ️")
...
<div style="background-color: #1e1e1e; border-radius: 10px; border: 1px solid #4b6cb7; padding: 10px; margin: 10px 0; color: white;">
    ...
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/latamishra5/tryhackme-free-rooms" target="_blank" style="color: #4CAF50;">TryHackMe Free Rooms</a></li>
        <li><a href="https://github.com/latamishra5/Awesome-Hacking" target="_blank" style="color: #4CAF50;">Awesome Hacking</a></li>
    </ul>
    <div style="margin-bottom: 5px;"><b>Programming Languages:</b></div>
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/latamishra5/Awesome-Java" target="_blank" style="color: #4CAF50;">Awesome Java</a></li>
        <li><a href="https://github.com/latamishra5/30-Days-Of-Rust" target="_blank" style="color: #4CAF50;">30 Days Of Rust</a></li>
    </ul>
    <div style="margin-bottom: 5px;"><b>Data Structures & Algorithms:</b></div>
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/latamishra5/GeeksforGeeks-POTD" target="_blank" style="color: #4CAF50;">GeeksforGeeks POTD</a></li>
        <li><a href="https://github.com/latamishra5/Leetcode-POTD" target="_blank" style="color: #4CAF50;">Leetcode POTD</a></li>
    </ul>
    <div style="margin-bottom: 5px;"><b>AI/ML Projects:</b></div>
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/latamishra5/AI-Nexus" target="_blank" style="color: #4CAF50;">AI Nexus</a></li>
    </ul>
"""
